...
export default function ChatbotPage() {
  const STORAGE_KEY = 'kodemy_chat_history';
  ...
  const [messages, setMessages] = useState<Message[]>(() => {
    ...
    return [{ role: 'assistant', content: 'Hello! I am the Kodemy AI Assistant. How can I help you with your learning today?' }];
  });
      ...
      <header className="sticky top-0 z-10 bg-[#1c1d1f] border-b border-gray-800 shadow-sm flex items-center justify-between h-16 px-6">
        ...
        <div className="flex items-center gap-4">
          <button
            title="Clear chat"
            onClick={() => {
              const reset = [{ role: 'assistant' as const, content: 'Hello! I am the Kodemy AI Assistant. How can I help you with your learning today?' }];
              setMessages(reset);
